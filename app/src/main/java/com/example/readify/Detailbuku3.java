...
public class Detailbuku3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.detail_buku3);
        ...
        bookmarkButton.setOnClickListener(v -> handleButtonClick(
                getString(R.string.title_night_spinner),
                bookAuthors,
                "bookmark",
                "MyPrefs",
                "SELECTED_BOOK_TITLE"
        ...
        membacaButton.setOnClickListener(v -> {
            ...
            startActivity(new Intent(Detailbuku3.this, Hal3.class));
        });
    }
        ...
        query.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()) {
                    Toast.makeText(Detailbuku3.this, "Buku sudah ada di " + path + ".", Toast.LENGTH_SHORT).show();
                } else {
                    mDatabase.child(path).push().setValue(book);
                    Toast.makeText(Detailbuku3.this, "Ditambahkan ke " + path, Toast.LENGTH_SHORT).show();
                }
            }
