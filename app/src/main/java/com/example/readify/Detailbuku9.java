...
public class Detailbuku9 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.detail_buku9);
        ...
        bookmarkButton.setOnClickListener(v -> handleButtonClick(
                getString(R.string.title_matahari),
                bookAuthors,
                "bookmark",
                "MyPrefs",
                "SELECTED_BOOK_TITLE"
        ...
        membacaButton.setOnClickListener(v -> {
            ...
            startActivity(new Intent(Detailbuku9.this, Hal9.class));
        });
    }
        ...
        query.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()) {
                    Toast.makeText(Detailbuku9.this, "Buku sudah ada di " + path + ".", Toast.LENGTH_SHORT).show();
                } else {
                    mDatabase.child(path).push().setValue(book);
                    Toast.makeText(Detailbuku9.this, "Ditambahkan ke " + path, Toast.LENGTH_SHORT).show();
                }
            }
