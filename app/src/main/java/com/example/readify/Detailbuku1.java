...
public class Detailbuku1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.detail_buku1);
        ...
        bookmarkButton.setOnClickListener(v -> handleButtonClick(
                getString(R.string.title_last_train_to_istanbul),
                bookAuthors,
                "bookmark",
                "MyPrefs",
                "SELECTED_BOOK_TITLE"
        ...
        membacaButton.setOnClickListener(v -> {
            ...
            startActivity(new Intent(Detailbuku1.this, Hal1.class));
        });
    }
        ...
        query.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()) {
                    Toast.makeText(Detailbuku1.this, "Buku sudah ada di " + path + ".", Toast.LENGTH_SHORT).show();
                } else {
                    mDatabase.child(path).push().setValue(book);
                    Toast.makeText(Detailbuku1.this, "Ditambahkan ke " + path, Toast.LENGTH_SHORT).show();
                }
            }
