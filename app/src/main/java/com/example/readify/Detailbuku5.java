...
public class Detailbuku5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.detail_buku5);
        ...
        bookmarkButton.setOnClickListener(v -> handleButtonClick(
                getString(R.string.title_kimi_no_nawa),
                bookAuthors,
                "bookmark",
                "MyPrefs",
                "SELECTED_BOOK_TITLE"
        ...
        membacaButton.setOnClickListener(v -> {
            ...
            startActivity(new Intent(Detailbuku5.this, Hal5.class));
        });
    }
        ...
        query.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()) {
                    Toast.makeText(Detailbuku5.this, "Buku sudah ada di " + path + ".", Toast.LENGTH_SHORT).show();
                } else {
                    mDatabase.child(path).push().setValue(book);
                    Toast.makeText(Detailbuku5.this, "Ditambahkan ke " + path, Toast.LENGTH_SHORT).show();
                }
            }
