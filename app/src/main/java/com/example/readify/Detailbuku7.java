...
public class Detailbuku7 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.detail_buku7);
        ...
        bookmarkButton.setOnClickListener(v -> handleButtonClick(
                getString(R.string.title_about_you),
                bookAuthors,
                "bookmark",
                "MyPrefs",
                "SELECTED_BOOK_TITLE"
        ...
        membacaButton.setOnClickListener(v -> {
            ...
            startActivity(new Intent(Detailbuku7.this, Hal7.class));
        });
    }
        ...
        query.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()) {
                    Toast.makeText(Detailbuku7.this, "Buku sudah ada di " + path + ".", Toast.LENGTH_SHORT).show();
                } else {
                    mDatabase.child(path).push().setValue(book);
                    Toast.makeText(Detailbuku7.this, "Ditambahkan ke " + path, Toast.LENGTH_SHORT).show();
                }
            }
